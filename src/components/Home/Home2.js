      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <i>
                <b className="purple"> Back and Front-end development, Database Management, Machine Learning and Data Analysis . </b>
              </i>
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/MarcoAraujo02"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/marco-antonio-araujo-444815230/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
